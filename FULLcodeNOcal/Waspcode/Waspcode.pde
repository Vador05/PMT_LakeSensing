...
#=======================================#
 ...
 #=======================================#
 V. SD ok! lora ? sensors ok! cal NOK!
 #============================#==========#
 || SENSOR                   ||     PIN  ||
 #============================#==========#
 | Temperature                |  ANALOG5 |
...
void loop()
{
  ...
  */
  ...
  //==================SONAR======================
  frame.addSensor(SENSOR_STR, (uint8_t) value);
  
  //==================TEMP=======================
  frame.addSensor(SENSOR_STR, (uint8_t) value2);
  
  //==================D.O.=======================
  frame.addSensor(SENSOR_STR, (uint8_t) value3);
  
  //==================COND=======================
  frame.addSensor(SENSOR_STR, (uint8_t) value4);
